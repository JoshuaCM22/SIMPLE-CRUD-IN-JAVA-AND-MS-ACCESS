...
public class JFrame_AddNewStudent extends javax.swing.JFrame {
    ...
    private String ImgPath, gender, combination;
    ...
    private void ComputingAge() {
        try {
            String monthValue = cmbboxMonth.getSelectedItem().toString();
            String dayValue = cmbboxDay.getSelectedItem().toString();
        ...
        if (txtLastName.getText().equals("")) {
            ...
            try {
                ...
                if (ImgPath != null) {
                    ...
                    String sql = "INSERT INTO tbl_Students (last_name, given_name, middle_name, gender_id, date_of_birth, age, address, photo) VALUES (?, ?, ?, ?, ?, ?, ?,?)";
