...
public class JFrame_Profile extends javax.swing.JFrame {
        ...
        if (P == JOptionPane.YES_OPTION) {
            try {
                ...
                if (rs.next()) {
                    ...
                    txtGivenName.setText(rs.getString("given_name"));
                    ...
                    Image CC = BB.getScaledInstance(lblProfile.getWidth(), lblProfile.getHeight(), java.awt.Image.SCALE_SMOOTH);
                    AA = new ImageIcon(CC);
                    lblProfile.setIcon(AA);
                    Disabled();
                }
                rs.close();
                con.commit();
    ...
    private void Updating() {
        try {
            ...
            if (P == JOptionPane.YES_OPTION) {
                if (imgPath != null) {
                    pst = con.prepareStatement("UPDATE tbl_students SET Last_Name=?, Given_Name=?, Middle_Name=?, Gender_Id=?, Date_of_Birth=?, Age=?, Address=?, Photo=? WHERE ID=?");
